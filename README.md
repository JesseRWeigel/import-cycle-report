...
Import cycle report as a single self-contained HTML file

Catalog task: `DEVT-024`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
